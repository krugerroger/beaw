        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mb-12 text-center lg:text-left">
            ...
            <p className="max-w-2xl" style={{ color: "#71717a" }}>
              Veuillez remplir le formulaire ci-dessous. Chaque demande est
              traitée avec la plus grande discrétion.
            </p>
          </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl group">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.15) 50%, transparent 100%)",
                  }}
                />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="form-control w-full">
                      <label
                        className="label text-xs font-semibold uppercase tracking-wider pb-1"
                        style={{ color: "#52525b" }}
                      >
                        Durée souhaitée
                      </label>
                    ...
                    <div
                      className="p-4 rounded-xl flex flex-col justify-center items-center"
                      style={{
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="form-control">
                      ...
                      <div className="relative">
                        <Calendar
                          className="absolute left-3 top-3.5 h-5 w-5 z-10 pointer-events-none"
                          style={{ color: "#52525b" }}
                        />
                        <input
                          type="datetime-local"
          ...
          >
            <div className="text-center mb-10">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest">
                Plateformes de recharge
              </h2>
              <p className="mt-2 italic" style={{ color: "#52525b" }}>
                Achetez votre recharge en toute sécurité sur ces sites officiels
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className="w-12 h-12 rounded-lg flex items-center justify-center font-bold italic text-lg transition-colors"
          ...
          {/* Confirmation & rappel */}
          <div
            className="mt-12 rounded-2xl p-6 max-w-4xl mx-auto"
          ...
          >
            ...
            >
              <li>
                Confirmation immédiate après réservation par Telegram ou email.
              </li>
              <li>Un rappel sera envoyé 24 heures avant le rendez-vous.</li>
              <li>
                Une facture détaillée vous sera envoyée après la réservation.
              </li>
              <li>
                La réservation est confirmée uniquement après réception de la
                facture.
              </li>
            </ul>
          </div>
          ...
          <div
            className="mt-12 text-center text-sm max-w-2xl mx-auto italic"
            style={{ color: "#3f3f46" }}
          >
