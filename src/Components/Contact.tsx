            ...
            <div id="reserver" className="card bg-base-200 shadow-lg p-6">
              ...
              <div className="flex flex-col gap-6 p-4">
                <a 
                  ...
                  className="btn btn-outline border-primary text-primary hover:bg-transparent hover:text-black hover:-translate-y-1 transition-all duration-200 flex items-center gap-2 px-6"
                >
                  <svg
